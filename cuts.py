...
for ipt in range(len(ptbins)-1):  
  ...
  for algo in algos:
    for wp in list(wps[algo].keys()):
      ...
      #cuts[baseCutNameAndTaggerFail+"SV"] = cuts[baseCutNameAndTaggerFail] + "&& (GoodTagVarCSV_vertexMass>0)"
  ...
  for flavor in flavors:
    ...
    for algo in algos:
      for wp in list(wps[algo].keys()):
        ...
        #cuts[baseCutNameAndFlavorAndTaggerFail+"_SV"] = cuts[baseCutNameAndFlavorAndTaggerFail]+ "&& (GoodTagVarCSV_vertexMass>0)"
